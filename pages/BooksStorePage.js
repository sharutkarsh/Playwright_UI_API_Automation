...
class BooksStorePage extends BasePage {
  ...
  async searchBook(title) {
    ...
    // Wait for the table to reflect filtered results instead of a hard timeout
    // This is Playwright's auto-wait in action — no arbitrary sleep needed
    await expect(this.bookTitleLink(title)).toBeVisible();
  }
